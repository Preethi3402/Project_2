...
function Shome() {
  ...
  return (
    <div>
      ...
      <Card body style={{ backgroundColor: "#60c99dff", width: "80%", marginLeft: "10%", marginTop: "20px", height: "580px" }}>
       ...
       <br/>
       <br/>
       <div style={{paddingLeft:"350px",background:'#60c99dff'}}>
       <BarChart width={400} height={300} data={data} >
          <XAxis dataKey="name" />
          <YAxis />
          <Tooltip   />
          <Legend />
          <Bar dataKey="value" fill="#ebebf1ff" barSize={70} />
