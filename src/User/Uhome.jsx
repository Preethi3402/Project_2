 ...
 navigate('/uproducts')
  ...
  return (
    <div>
      ...
      <h1 className='text-center' style={{fontSize:"50px",backgroundColor:"#60c99dff"}}>Best Seller</h1>
      <div  style={{display:"flex",justifyContent:"center",backgroundColor:"#60c99dff"}}>
  
  <div style={{ display: 'flex', justifyContent: 'space-between',backgroundColor:"#60c99dff" }}>
  <Card style={{ width: '20rem' ,marginRight:"80px"}}>
  <Link to='/uproducts'>
    ...
    <Card.Body style={{backgroundColor:"#60c99dff"}}>
  ...
  <br/> */}
  <div>
      <h1 className='text-center' style={{fontSize:"50px",backgroundColor:"#60c99dff"}}>Top Recomendation</h1>
      <div  style={{display:"flex",justifyContent:"center",backgroundColor:"#60c99dff"}}>
