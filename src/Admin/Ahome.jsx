...
function Ahome() {
  ...
  return (
    <div>
        <Anavbar/>
      <h3 className="text-center" style={{color:"black",background:"#60c99dff"}}>DashBoard</h3>
      <Card body style={{ background: "#60c99dff", width: "80%", marginLeft: "10%", marginTop: "20px", height: "580px" }}>
