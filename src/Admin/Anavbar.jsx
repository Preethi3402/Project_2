...
const Anavbar = () => {
  ...
  return (
    <Navbar bg="" variant="dark" expand="lg" style={{backgroundColor:"#60c99dff"}}>
      <Container>
        <Navbar.Brand><Link to='/shome' style={{color:"black",textDecoration:"none"}}>Book Bank(Admin)</Link></Navbar.Brand>
